...
export const locales = {
  ...
  part3_edit_title_desc: 'Pour chaque séquence, vous pouvez choisir d’ajouter un titre. Par défaut, il s’agit du titre de la séquence, mais vous pouvez le modifier !',
